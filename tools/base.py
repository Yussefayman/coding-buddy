...
class Tool(abc.ABC):
    ...
    def schema(self) -> dict[str, Any] | type['BaseModel']:
        raise NotImplementedError("Tool must define schema property or class attributes")
    ...
    def is_mutatuing(self, params: dict[str, Any]) -> bool:
    ...
    async def get_confirmation(self, invokation: ToolInvokation) -> ToolInvokation | None:
        if not self.is_mutatuing(invokation.params):
            return None
